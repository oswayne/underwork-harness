/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-uicp-web-app`.
 * @module @deepseek-ai/dsh-uicp-web-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-uicp-web-app'

/** Cordis companion plugin name. */
export const name = 'uicp-web-app-bundle-invariant'
