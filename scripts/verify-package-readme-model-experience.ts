...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/uicp-web-app': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; each inserted row\'s package owns its model-facing behavior.' },
  'packages/uicp/api-proxy': { kind: 'none', reason: 'The same-origin HTTP proxy forwards already-composed platform requests and registers nothing model-facing.' },
  'packages/uicp/contract-matrix': { kind: 'none', reason: 'The behavior-matrix corpus runs outside model requests and registers nothing model-facing.' },
  'packages/uicp/eureka-preview-host': { kind: 'none', reason: 'The browser preview bundle renders page JSON in the client and registers nothing model-facing.' },
  'packages/uicp/preview-backend': { kind: 'none', reason: 'The preview seam serves browser/editor assets and sandbox data routes; the model reaches it only through the tool packages.' },
  'packages/uicp/sandbox-server': { kind: 'none', reason: 'The local data sandbox answers HTTP data routes and registers nothing model-facing.' },
  'packages/client/ui-apppackage-workspace': { kind: 'none', reason: 'Browser-side app-package workspace chrome; nothing here reaches a model request.' },
  'packages/client/ui-uicp-nav': { kind: 'none', reason: 'Browser-side sign-in and tenant/app-package navigation chrome; nothing here reaches a model request.' },
